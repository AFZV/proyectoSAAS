      ...
      <div className="bg-card border rounded-xl p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="font-semibold text-sm text-foreground">Distribución de Ventas</h3>
              <p className="text-xs text-muted-foreground">Evolución mensual de ventas</p>
            </div>
          </div>
      ...
      <div className="bg-card border rounded-xl p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="font-semibold text-sm text-foreground">Distribución de Cobros</h3>
              <p className="text-xs text-muted-foreground">Recaudos mensuales realizados</p>
            </div>
          </div>
          <div className="flex items-center space-x-1 text-xs text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded-full">
            <TrendingUp className="h-3 w-3" />
