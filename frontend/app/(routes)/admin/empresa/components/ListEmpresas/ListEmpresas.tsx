import { Empresa, columns } from "./columns";
...
export async function getEmpresas(): Promise<Empresa[]> {
  try {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/empresa/all`, {
      headers: {
  ...
  return (
    <section className="min-h-screen bg-background text-foreground px-4 py-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Mensaje de ayuda cuando no hay Empresas */}
        {data.length === 0 && (
          <div className="mt-6 text-center p-8 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <p className="text-blue-700 dark:text-blue-300 mb-4">
              Crea tu primer Empresa usando el botón Crear Empres en la parte
              superior.
            </p>
            <div className="text-sm text-blue-600 dark:text-blue-400">
              💡 <strong>Tip:</strong> También puedes usar Actualizar Empresas
